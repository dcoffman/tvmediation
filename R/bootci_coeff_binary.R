...
#' @return \item{CI.lower.a}{lower limit of confidence intervals for alpha_hat}
#' @return \item{CI.upper.a}{upper limit of confidence intervals for alpha_hat}
#' @return \item{CI.lower.g}{lower limit of confidence intervals for gamma_hat}
#' @return \item{CI.upper.g}{upper limit of confidence intervals for gamma_hat}
#' @return \item{CI.lower.b}{lower limit of confidence intervals for beta_hat}
#' @return \item{CI.upper.b}{upper limit of confidence intervals for beta_hat}
#' @return \item{CI.lower.t}{lower limit of confidence intervals for tao_hat}
#' @return \item{CI.upper.t}{upper limit of confidence intervals for tao_hat}
#' 
#' @export
#' 
##### *********************************************************************** #####
...
bootci_coeff_binary <- function(treatment, t.seq, m, outcome, replicates = 1000){
  ...
  #matrix with total, direct and indirect (mediation) effects for each individual at each time
