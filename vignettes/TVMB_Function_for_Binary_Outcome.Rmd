...
2.  `CI.lower.a1` the lower limit of confidence intervals for alpha1_hat
3.  `CI.upper.a1` the upper limit of confidence intervals for alpha1_hat
4.  `beta1_hat` the estimated effect of the intervention on the outcome
5.  `CI.lower.b1` the lower limit of confidence intervals for beta1_hat
6.  `CI.upper.b1` the upper limit of confidence intervals for beta1_hat
7.  `beta2_hat` the estimated effect of the mediator on the outcome
8.  `CI.lower.b2` the lower limit of confidence intervals for beta2_hat
9.  `CI.upper.b2` the upper limit of confidence intervals for beta2_hat
10. `medEffect` the time varying mediation effect (estimated via product method)

Optional returns based on arguments `CI = "boot"` passed by the user include:

11. `CI.low` the lower limit of confidence intervals of the time varying mediation effect
12. `CI.upper` the upper limit of confidence intervals of the time varying mediation effect
...
14. `plot2_b1` plot for beta1_hat across `timeseq` (`= t.seq`)
15. `plot3_b2` plot for beta2_hat across `timeseq` (`= t.seq`)
15. `MedEff` plot for mediation effect estimated via product method across `timeseq` (`= t.seq`)
16. `MedEff_CI` plot for `medEffect` along with confidence intervals (estimated via bootstrap) across `timeseq` (`= t.seq`)
17. `bootstrap` plot for estimated mediation effects from bootstrapped samples across `timeseq` (`= t.seq`)
