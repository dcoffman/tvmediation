...
The above plot shows the total effect of `varenicline` on the outcome subjects' `daily smoking status` which follows a sinusoidal trend over time with occasional spikes around the end of weeks 4-6 and 14. The estimated 95% CI covers 0 (no effect).
