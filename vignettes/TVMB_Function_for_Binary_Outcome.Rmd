...
10. `tao_hat`    the estimated main treatment arm (exposure group) of interest effect on outcome, excluding adjustment for mediator
11. `CI.lower.t` the lower limit of confidence intervals for coefficient tao_hat
12. `CI.upper.t` the upper limit of confidence intervals for coefficient tao_hat
...
19. `plot4_t` plot for `tao_hat` with 95% CIs across timeseq (`= t.seq`)
