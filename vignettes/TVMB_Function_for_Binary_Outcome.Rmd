...
In addition, you will want to install and load the `locpol`, `ggplot2`, `kedd`, `stats` and `dplyr` packages which are necessary for certain functions to operate in the `tvmediation` package.
