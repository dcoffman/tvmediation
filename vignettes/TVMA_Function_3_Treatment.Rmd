...
14. `hat.beta` the estimated effect of the mediator on the outcome
15. `CI.lower.beta` the lower limit of confidence intervals for hat.beta
16. `CI.upper.beta` the upper limit of confidence intervals for hat.beta
...
27. `plot3_g1` plot for `hat.gamma1` with 95% CIs across `timeseq`
28. `plot4_g2` plot for `hat.gamma2` with 95% CIs across `timeseq`
29. `plot5_b` plot for `hat.beta` with 95% CIs across `timeseq`
