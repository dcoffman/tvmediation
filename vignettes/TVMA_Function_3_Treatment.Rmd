...
12. `CI.lower.NRT1` the lower confidence intervals for the time varying mediation effect of treatment1
13. `CI.upper.NRT1` the upper confidence intervals for the time varying mediation effect of treatment1
14. `CI.lower.NRT2` the lower confidence intervals for the time varying mediation effect of treatment2
15. `CI.upper.NRT2` the upper confidence intervals for the time varying mediation effect of treatment2
16. `SE_MedEff1` estimated standard error of the time varying mediation effect for treatment1
17. `SE_MedEff2` estimated standard error of the time varying mediation effect for treatment2
