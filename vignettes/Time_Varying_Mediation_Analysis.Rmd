...
2. `CI.lower.alpha1` the lower limit of confidence intervals for coefficient alpha1
3. `CI.upper.alpha1` the upper limit of confidence intervals for coefficient alpha1
4. `hat.beta.1` the estimated treatment effect on outcome
5. `CI.lower.beta1` the lower limit of confidence intervals for coefficient beta1
6. `CI.upper.beta1` the upper limit of confidence intervals for coefficient beta1
7. `hat.beta.2` the estimated mediator effect on outcome
8. `CI.lower.beta2` the lower limit of confidence intervals for coefficient beta2
9. `CI.upper.beta2` the upper limit of confidence intervals for coefficient beta2
10. `est.M` the time varying mediation effect

Optional returns based on arguments `CI = "boot"` include:

11. `boot.se.m` the estimated standard error of the time varying mediation effect
12. `CI.lower` the lower limit of confidence intervals of the time varying mediation effect
13. `CI.upper` the upper limit of confidence intervals of the time varying mediation effect
...
14. `Alpha1_CI` plot for hat.alpha.1 across timeseq (`t.seq`) with CI
15. `Beta1_CI` plot for hat.beta.1 across timeseq (`t.seq`) with CI
16. `Beta2_CI` plot for hat.beta.2 across timeseq (`t.seq`) with CI
17. `MedEff` plot for mediation.effect across timeseq (`t.seq`)
18. `MedEff_CI` plot for CIs of mediation.effect across timeseq (`t.seq`)
