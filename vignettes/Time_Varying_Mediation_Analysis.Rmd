...
In the above plot, the effect of subjects' `negative mood in the last fifteen minutes` on the outcome `cessation fatigue` is increasing initially and stabilizing over time with occassional spikes around day 6-7 (end of week 1) and day 20-21 (end of week 3).
